...
export default function PortfolioModal({ modalOpen, closeModal }) {
     return (
          <div className={`modal portfolio-modal-box fade ${modalOpen ? 'show' : ''}`} tabIndex="-1" role="dialog" style={{ display: modalOpen ? 'block' : 'none' }}>
               <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                         <div class="modal-header">
                              <button onClick={closeModal} type="button" class="close" data-bs-dismiss="modal">
