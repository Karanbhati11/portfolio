(function ($) {
  ...
  window.addEventListener("DOMContentLoaded", function () {
    // Wrap your code inside this event listener to ensure it runs after the DOM has been fully loaded

    // Retrieve the preloader element
    let preloader = document.querySelector("#preloader");

    // Check if the preloader element exists
    if (preloader) {
      // If the preloader exists, add the "preloaded" class after window load
      window.addEventListener("load", function () {
        preloader.classList.add("preloaded");
        setTimeout(function () {
          preloader.remove();
